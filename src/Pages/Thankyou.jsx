  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg text-center">
        ...
        <p className="mt-2 text-gray-600">Your order has been placed successfully at IndieStorie.</p>
        <p className="mt-4 text-gray-500">You will be redirected to the home page in {timeoutTimer} seconds...</p>
      </div>
    </div>
  );
};
